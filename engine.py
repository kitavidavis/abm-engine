# Dynamic, interactive simulation GUI for agent-based modelling
# Author: David Kitavi

import matplotlib

# system check, from Steve Morgan
import platform
...
class Engine:
    def __init__(self, title="GeoPsy ABM", interval=0, stepSize=1, parameterSetters=[]):
        ...
        self.setStatusStr("Simulation is OFF")
